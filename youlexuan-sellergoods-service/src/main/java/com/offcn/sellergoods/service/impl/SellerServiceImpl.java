...
//                criteria.andStatusEqualTo(seller.getStatus());
                    String[] statuses = seller.getStatus().split(",");

                    List<String> strings = Arrays.asList(statuses);
...
//        TbSeller tbSeller = sellerMapper.selectByPrimaryKey(sellerId);//通过id获取实体
//        tbSeller.setStatus(status);//设置新的状态
//        sellerMapper.updateByPrimaryKey(tbSeller);//修改状态
